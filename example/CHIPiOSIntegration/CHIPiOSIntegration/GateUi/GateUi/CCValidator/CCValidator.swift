...
public class CCValidator: NSObject {
    ...
    private class func mirSpecs() -> (prefixes: [CreditCardPrefix], lengths: [Int]) {
        return (
            prefixes: [CreditCardPrefix(rangeStart: 2200, rangeEnd: 2204, length: 4)],
            lengths: [16, 17, 18, 19]
        )
    }
